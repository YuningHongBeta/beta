...
class calDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    calDetectorConstruction();
...
inline const G4VPhysicalVolume* calDetectorConstruction::GetAbsorberPV() const { 
  return fAbsorberPV; 
}
inline const G4VPhysicalVolume* calDetectorConstruction::GetCellPV() const { 
  return fCellPV; 
}
